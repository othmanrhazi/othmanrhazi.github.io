...
### How to make changes
 ...
 `gh-pages` is different from master in that it contains sharing features, analytics and other things that have no direct bearing with the game. `master` is the "pure" version of the repo.
...
### Changes that are welcome
 ...
 - New Documents related to Mathematics or Finance
 - "Under the hood" enhancements
 - Small changes that don't have an impact on the core website
